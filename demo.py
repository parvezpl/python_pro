...
#
# try:
#     driver.switch_to.window(fwin)
# except Exception as e:
#     print("demo me switching ka problem", e)
# try:
#     aa=driver.find_element(By.XPATH,"/html/body/form/div[3]/div/div/div[1]/h4")
#     print(aa.text[0:8])
#     qw_obj=Answer()
...
#     qw_obj.qw4()
#     qw_obj.qw5()
#     print("qw solved , done")
#     # driver.find_element(By.XPATH,"/html/body/form/div[3]/div/div/div[2]/div/div/div/input[1]").click() #submit
#     # txt=driver.find_element(By.XPATH,"/html/body/div/div/div[2]").text # submit pop up
#
# except Exception as e:
#     print("during qw solve some proble",e)
#
